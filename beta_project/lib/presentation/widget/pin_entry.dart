...
/// Adapted from: [https://github.com/prestigegodson/pin-entry-text-field/blob/master/pin_entry_text_field/lib/pin_entry_text_field.dart]
...
class PinEntryTextFieldState extends State<PinEntryTextField> {
  ...
  Widget buildTextField(int i, BuildContext context, [bool autofocus = false]) {
    ...
    if (_textControllers[i] == null) {
      ...
      if (widget.lastPin != null && widget.lastPin.isNotEmpty) {
